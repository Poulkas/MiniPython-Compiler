...
void AnalizadorSintactico::imprimeArbol(){
    ...
    while(aux){
        if(aux->asig){
            ...
            imprimeSentencias(aux->mientras->sent);
            lexico->archivoSalida <<"</BLOQUE>\n";
            lexico->archivoSalida <<"</MIENTRAS>\n";
        }else if(aux->sel){
            ...
            lexico->archivoSalida <<"<BLOQUE>\n";
            imprimeSentencias(aux->sel->sent_if);
            lexico->archivoSalida <<"</BLOQUE>\n";
            if(aux->sel->sent_else){
                lexico->archivoSalida <<"<OTRO>\n";
                imprimeSentencias(aux->sel->sent_else);
                lexico->archivoSalida <<"</OTRO>\n";
            }lexico->archivoSalida <<"</SI>\n";
        }else if(aux->print){
...
void AnalizadorSintactico::imprimeExpresion(Expresion* exp){
    if(exp->tipo=='v'){
        ...
        lexico->archivoSalida <<"<EXPRESION value=\""+exp->simbolo+"\">\n";
        imprimeExp(exp->izq);
        imprimeExp(exp->der);
